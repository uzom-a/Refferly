        ...
        <div className="grid gap-4 md:grid-cols-3">
          <Card className="bg-gradient-to-br from-rose-50 to-emerald-50 p-6 shadow-lg border-2 border-rose-200">
            <div className="space-y-2">
              <div className="text-xs font-semibold uppercase tracking-wide text-rose-700">Trust score</div>
          ...
          <Card className="bg-gradient-to-br from-orange-50 to-purple-50 p-6 shadow-lg border-2 border-orange-200">
            <div className="space-y-2">
              <div className="text-xs font-semibold uppercase tracking-wide text-orange-700">Verified jobs</div>
              <div className="text-4xl font-bold bg-gradient-to-r from-orange-600 to-purple-600 bg-clip-text text-transparent">
                {stats.verifiedJobs}
              </div>
            </div>
          </Card>
